...
|名称      |期間       |概要・経験 |
|:--------|:---------|:---------|
|React|2年|・スタートアップのPoC開発<br/>・状態管理にReduxを使用<br/>・その他、周辺ライブラリとの組み合わせ|
|Vue.js|2年|・BtoB SaaSのフロントエンド開発<br/>・学習のため独学でツールを作成|
|jQuery|3年|・社内システムの開発<br/>・その他、|

##### Backend

|名称      |期間       |概要・経験 |
|:--------|:---------|:---------|
|Spring Boot|5年|・業務にてモノリシックアプリケーションやREST APIの作成で使用し経験豊富|
|Seasar2|3年|・社内システムの開発|
|Jersey|1年|・OAuth 2.0の認証サーバやREST APIのエンドポイントの作成を経験|
...
- Spock Frameworkを利用したUnit Test/API Layer Testの方針策定、設計と実装
...
- Seasar2を用いたWEBアプリ開発
    - 初めてのWEBフレームワークを用いた開発
    - フレームワークの理解を正しくしたいと思い、手元にホワイトボードを用意し自分の理解をすり合わせる努力をした
    - フレームワークのコードリーディング手法を先輩に教わり、公式ドキュメントと照らし合わせて動きを理解した
- jQuery Mobileを用いたFrontendの開発
- チーム内勉強会「すげぇ会」の運営
